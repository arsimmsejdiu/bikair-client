...
import {Image, ImageBackground, StatusBar, TouchableHighlight, TouchableOpacity, View, ViewProps} from "react-native";
...
const NewsScreen: FC<Props> = ({navigation}): ReactElement => {
    ...
    return (
        <View style={{
            ...
            >
                <Image source={Close} style={newsPopupStyles.imageSize} resizeMode={"cover"}/>
            </TouchableOpacity>
            <View style={{
